 ...
 * mint (a client's mistake, 400), and 23505 for an add of a row that is
 * already there (409); anything else is the server's (500).
 */
const CODE_OF_SQLSTATE: Record<string, number> = { "22023": 400, "22P02": 400, "23505": 409 };
